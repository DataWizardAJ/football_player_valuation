...
@st.cache_resource
def load_models():
    pipeline = joblib.load('football_transfer_pipeline.joblib')
    rf_no_mv = joblib.load('rf_no_market_value.pkl')
...
# Search box with autocomplete from player list
...
if player_name:
    ...
    if results is None:
        ...
        col3.metric('Overvalued', total_transfers - undervalued_count)


#To run it, open your terminal in that folder and run:
